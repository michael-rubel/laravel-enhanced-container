...
class OriginalContainerTest extends TestCase
{
    ...
    public function testInternalClassWithDefaultParameters()
    {
        ...
        $this->expectExceptionMessage('Unresolvable dependency resolving [Parameter #0 [ <required> $first ]] in class MichaelRubel\EnhancedContainer\Tests\ContainerMixedPrimitiveStub');
    ...
    {
        $this->expectException(BindingResolutionException::class);
        $this->expectExceptionMessage('Target [MichaelRubel\EnhancedContainer\Tests\IContainerContractStub] is not instantiable.');
    ...
    {
        $this->expectException(BindingResolutionException::class);
        $this->expectExceptionMessage('Target [MichaelRubel\EnhancedContainer\Tests\IContainerContractStub] is not instantiable while building [MichaelRubel\EnhancedContainer\Tests\ContainerDependentStub].');
